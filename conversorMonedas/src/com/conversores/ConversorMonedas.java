	...
	public ConversorMonedas() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				switch (p) {
					...
					case "GBP - Libra Esterlina":
						img1.setIcon(new ImageIcon(ConversorMonedas.class.getResource("/com/recursos/ru.jpg")));
						break;
		...
		cbDivisasFinal.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				switch (t) {
					case "PEN - Sol Peruano":
						img2.setIcon(new ImageIcon(ConversorMonedas.class.getResource("/com/recursos/peru.jpg")));
						break;
					case "USD - Dolar":
					...
					case "EUR - Euro":
						...
						break;
					case "GBP - Libra Esterlina":
						img2.setIcon(new ImageIcon(ConversorMonedas.class.getResource("/com/recursos/ru.jpg")));
						break;
					case "JPY - Yen Japonés":
